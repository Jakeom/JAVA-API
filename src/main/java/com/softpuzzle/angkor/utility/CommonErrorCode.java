...
public enum CommonErrorCode implements ErrorCode{
	...
	SUCCESS                          (0000, "success","Completed"),
	...
	MAIL_TIME_OVER               (1009, "The verification code you entered has expired. Please request a new code and try again.",""),
	...
	QR_SCAN_NO_FOUND            (1019, "No user found with this QR code. Please double-check and try again.",""),
	FILE_SIZE_OVER            (1020, "You can attach up to 5 files, 30 MB each.",""),
	FILE_FORMAT_ERROR            (1021, "You can attach up jpg, jpeg, png, mp4, mov",""),
	QUESTION_SET_SEVER_ERROR            (1004, "Your question could not be submitted due to a server error. We apologize for the inconvenience. Please try again later.",""),
	SEARCH_UNAVAILABLE            (1022, "The user has chosen to keep their account private. You cannot automatically add or search for them using their phone number. Please try a different method.",""),
	...
	INVALID_ID                     (2006, "Oops, this ID does not seem to exist. Please check your entry and try again.",""),
	...
	API_400304						(400304, "The ID you entered is already in use. Please enter a different ID", ""),
	...
	API_400415						(400415, "Invalid e-mail address.",	""),
	...
	API_400418						(400418, "This Email is already in use", ""),
	...
	API_400603						(400603, "Invalid code. Please check your email and try again.", ""),
    API_400603_SMS					(400603, "Invalid confirmation code. Please check your SMS to find the correct code.", ""),
	...
	API_400613						(400613, "Invalid phone number. Please enter a valid phone number.",	""),
